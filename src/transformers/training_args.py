...
class TrainingArguments:
    ...
    **which relate to the training loop itself**.
    ...
    Parameters:
        ...
        disable_train_tqdm (:obj:`bool`, `optional`):
            Whether or not to disable the tqdm progress bars during training. Will default to :obj:`True` if the logging level is set
            to warn or lower (default), :obj:`False` otherwise.
        disable_prediction_tqdm (:obj:`bool`, `optional`):
            Whether or not to disable the tqdm progress bars during prediction. Will default to :obj:`True` if the logging level is set
            to warn or lower (default), :obj:`False` otherwise.
    ...
    disable_prediction_tqdm: Optional[bool] = field(
